...
fn updates_shutdown_wait() {
	...
	unwrap_send_err!(nodes[0].node.send_payment(&route_1, payment_hash, &recipient_info), true, APIError::ChannelUnavailable {..}, {});
	unwrap_send_err!(nodes[1].node.send_payment(&route_2, payment_hash, &recipient_info), true, APIError::ChannelUnavailable {..}, {});
