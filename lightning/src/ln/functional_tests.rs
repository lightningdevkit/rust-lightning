...
fn test_no_txn_manager_serialize_deserialize() {
	...
	let nodes_0_deserialized: ChannelManager<EnforcingChannelKeys>;
	let mut nodes = create_network(2, &node_cfgs, &node_chanmgrs);
...
fn test_data_loss_protect() {
	...
	node_state_0 = <(Sha256dHash, ChannelManager<EnforcingChannelKeys>)>::read(&mut ::std::io::Cursor::new(previous_node_state), ChannelManagerReadArgs {
