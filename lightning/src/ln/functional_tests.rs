...
pub fn test_async_inbound_update_fee() {
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &payment_event.commitment_msg); // (2)
	...
	nodes[1].node.handle_commitment_signed_batch(nodes[0].node.get_our_node_id(), commitment_signed);
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &bs_update.commitment_signed); // deliver (4)
	...
	nodes[1].node.handle_commitment_signed_batch(nodes[0].node.get_our_node_id(), &as_update.commitment_signed); // deliver (5)
...
pub fn test_multi_flight_update_fee() {
	...
	nodes[1].node.handle_commitment_signed_batch(nodes[0].node.get_our_node_id(), commitment_signed_1);
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &bs_commitment_signed);
	let as_revoke_msg = get_event_msg!(nodes[0], MessageSendEvent::SendRevokeAndACK, nodes[1].node.get_our_node_id());
	check_added_monitors!(nodes[0], 1);
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &bs_second_commitment);
	let as_second_revoke = get_event_msg!(nodes[0], MessageSendEvent::SendRevokeAndACK, nodes[1].node.get_our_node_id());
	// No commitment_signed so get_event_msg's assert(len == 1) passes
	check_added_monitors!(nodes[0], 1);
...
pub fn test_update_fee_with_fundee_update_add_htlc() {
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &commitment_update.commitment_signed);
	check_added_monitors!(nodes[0], 1);
...
pub fn test_update_fee() {
	...
	// Handle (3), creating (6):
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &commitment_signed_0);
	check_added_monitors!(nodes[0], 1);
...
pub fn holding_cell_htlc_counting() {
	...
	nodes[2].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &initial_payment_event.commitment_msg);
	...
	nodes[1].node.handle_commitment_signed_batch(nodes[2].node.get_our_node_id(), &bs_commitment_signed);
	check_added_monitors!(nodes[1], 1);
	...
	nodes[2].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &as_updates.commitment_signed);
	check_added_monitors!(nodes[2], 1);
...
pub fn test_channel_reserve_holding_cell_htlcs() {
	...
	nodes[1].node.handle_commitment_signed_batch(nodes[0].node.get_our_node_id(), &payment_event_1.commitment_msg);
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &as_commitment_signed);
...
pub fn channel_reserve_in_flight_removes() {
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &bs_removes.commitment_signed);
	check_added_monitors!(nodes[0], 1);
	let as_raa = get_event_msg!(nodes[0], MessageSendEvent::SendRevokeAndACK, nodes[1].node.get_our_node_id());
	expect_payment_sent(&nodes[0], payment_preimage_1, None, false, false);

	nodes[1].node.handle_update_add_htlc(nodes[0].node.get_our_node_id(), &send_1.msgs[0]);
	nodes[1].node.handle_commitment_signed_batch(nodes[0].node.get_our_node_id(), &send_1.commitment_msg);
	check_added_monitors!(nodes[1], 1);
	...
	nodes[1].node.handle_commitment_signed_batch(nodes[0].node.get_our_node_id(), &as_cs.commitment_signed);
	check_added_monitors!(nodes[1], 1);
	let bs_raa = get_event_msg!(nodes[1], MessageSendEvent::SendRevokeAndACK, nodes[0].node.get_our_node_id());
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &send_2.commitment_msg);
	check_added_monitors!(nodes[0], 1);
	let as_raa = get_event_msg!(nodes[0], MessageSendEvent::SendRevokeAndACK, nodes[1].node.get_our_node_id());
...
pub fn test_multiple_package_conflicts() {
	...
	nodes[0]
		.node
		.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &updates.commitment_signed);
	check_added_monitors(&nodes[0], 1);
	...
	nodes[1].node.handle_commitment_signed_batch(nodes[0].node.get_our_node_id(), &commit_signed);
...
pub fn test_force_close_fail_back() {
	...
	nodes[2].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &payment_event.commitment_msg);
	check_added_monitors!(nodes[2], 1);
	...
	if messages_delivered >= 1 {
		...
		if messages_delivered >= 2 {
			...
			if messages_delivered >= 3 {
				...
				if messages_delivered >= 4 {
					nodes[1].node.handle_commitment_signed_batch(nodes[0].node.get_our_node_id(), &as_commitment_signed);
					let bs_revoke_and_ack = get_event_msg!(nodes[1], MessageSendEvent::SendRevokeAndACK, nodes[0].node.get_our_node_id());
					// No commitment_signed so get_event_msg's assert(len == 1) passes
					check_added_monitors!(nodes[1], 1);
...
pub fn test_drop_messages_peer_disconnect_dual_htlc() {
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &bs_second_commitment_signed.commitment_signed);
	let as_revoke_and_ack = get_event_msg!(nodes[0], MessageSendEvent::SendRevokeAndACK, nodes[1].node.get_our_node_id());
	// No commitment_signed so get_event_msg's assert(len == 1) passes
	check_added_monitors!(nodes[0], 1);
...
fn do_htlc_claim_previous_remote_commitment_only(use_dust: bool, check_revoke_no_close: bool) {
	...
	nodes[1].node.handle_revoke_and_ack(nodes[0].node.get_our_node_id(), &as_updates.0);
	check_added_monitors!(nodes[1], 1);
	nodes[1].node.handle_commitment_signed_batch(nodes[0].node.get_our_node_id(), &as_updates.1);
	check_added_monitors!(nodes[1], 1);
	let bs_revoke_and_ack = get_event_msg!(nodes[1], MessageSendEvent::SendRevokeAndACK, nodes[0].node.get_our_node_id());
...
pub fn test_fail_holding_cell_htlc_upon_free_multihop() {
	...
	// Flush the pending fee update.
	nodes[2].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), commitment_signed);
	...
	nodes[1].node.handle_commitment_signed_batch(nodes[2].node.get_our_node_id(), &commitment_signed);
...
fn do_test_failure_delay_dust_htlc_local_commitment(announce_latest: bool) {
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &remove.commitment_signed);
	check_added_monitors!(nodes[0], 1);
...
fn do_test_onchain_htlc_settlement_after_close(broadcast_alice: bool, go_onchain_before_fulfill: bool) {
	...
	nodes[1].node.handle_commitment_signed_batch(nodes[2].node.get_our_node_id(), &carol_updates.commitment_signed);
	...
	check_added_monitors!(nodes[2], 1);
	nodes[2].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &bob_updates.commitment_signed);
	check_added_monitors!(nodes[2], 1);
...
pub fn test_disconnects_peer_awaiting_response_ticks() {
	...
	*nodes[0].fee_estimator.sat_per_kw.lock().unwrap() *= 2;
	...
	nodes[1].node.handle_commitment_signed_batch(nodes[0].node.get_our_node_id(), &alice_fee_update.commitment_signed);
	check_added_monitors!(&nodes[1], 1);
	...
	check_added_monitors!(&nodes[0], 1);
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &bob_commitment_signed);
	check_added_monitors(&nodes[0], 1);
...
fn do_test_multi_post_event_actions(do_reload: bool) {
	...
	nodes[0].node.handle_commitment_signed_batch(nodes[1].node.get_our_node_id(), &send_event.commitment_msg);
	assert!(nodes[0].node.get_and_clear_pending_msg_events().is_empty());
