...
use crate::util::config::{InboundChannelConfigOverrides, InboundChannelHandshakeConfigOverrides, InboundChannelUpdateOverrides, MaxDustHTLCExposure, UserConfig};
...
fn test_manually_accept_inbound_channel_request() {
	...
	let config_overrides = InboundChannelConfigOverrides {
		...
		update_overrides: Some(InboundChannelUpdateOverrides {
