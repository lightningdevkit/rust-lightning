...
#[cfg(dual_funding)]
use crate::ln::interactivetxs::{AbortReason, HandleTxCompleteValue, InteractiveTxConstructor, InteractiveTxMessageSend};
use crate::ln::msgs;
...
impl<SP: Deref> ChannelContext<SP> where SP::Target: SignerProvider  {
	...
	pub fn begin_interactive_funding_tx_construction<ES: Deref>(
		...
		entropy_source: &ES, is_initiator: bool, funding_inputs: Vec<(TxIn, TransactionU16LenLimited)>,
	...
	where ES::Target: EntropySource
	{
		...
		let total_input_satoshis: u64 = funding_inputs.iter().map(|input| input.1.as_transaction().output[input.0.previous_output.vout as usize].value).sum();
...
impl<SP: Deref> OutboundV2Channel<SP> where SP::Target: SignerProvider {
	...
	pub fn begin_interactive_funding_tx_construction<ES: Deref>(&mut self, signer_provider: &SP,
		entropy_source: &ES, funding_inputs: Vec<(TxIn, TransactionU16LenLimited)>
	) -> Result<Option<InteractiveTxMessageSend>, APIError>
	where ES::Target: EntropySource
	{
