...
use crate::ln::outbound_payment::{
	CustomTlvs, OutboundPayments, PendingOutboundPayment, RetryableInvoiceRequest,
...
pub struct OptionalPaymentParams {
	/// A set of custom tlvs, user can send along the payment.
	pub custom_tlvs: CustomTlvs,
...
impl Default for OptionalPaymentParams {
	fn default() -> Self {
		Self {
			custom_tlvs: CustomTlvs::new(vec![]).unwrap(),
...
/// # use lightning::ln::channelmanager::{AChannelManager, OptionalPaymentParams, PaymentId, RecentPaymentDetails, Retry};
/// # use lightning_invoice::Bolt11Invoice;
/// #
/// # fn example<T: AChannelManager>(
/// #     channel_manager: T, invoice: &Bolt11Invoice, optional_params: OptionalPaymentParams,
/// #     retry: Retry
/// # ) {
/// # let channel_manager = channel_manager.get_cm();
