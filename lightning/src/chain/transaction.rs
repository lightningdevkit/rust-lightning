...
mod tests {
	...
	fn test_channel_id_calculation() {
		...
		assert_eq!(
			&OutPoint { txid: tx.txid(), index: 0 }.to_channel_id(),
			&hex::decode("3e88dd7165faf7be58b3c5bb2c9c452aebef682807ea57080f62e6f6e113c25e").unwrap()[..]
		);
		assert_eq!(
			&OutPoint { txid: tx.txid(), index: 1 }.to_channel_id(),
			&hex::decode("3e88dd7165faf7be58b3c5bb2c9c452aebef682807ea57080f62e6f6e113c25f").unwrap()[..]
		);
	}
}
