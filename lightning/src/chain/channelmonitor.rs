...
pub(crate) struct ChannelMonitorImpl<Signer: EcdsaChannelSigner> {
	...
	/// The user-provided channel ID, used to populate events generated by the monitor.
...
pub(crate) fn write_chanmon_internal<Signer: EcdsaChannelSigner, W: Writer>(
	...
	write_tlv_fields!(writer, {
		...
		(43, channel_monitor.user_channel_id, option), // Added in 0.4
	});
...
impl<Signer: EcdsaChannelSigner> ChannelMonitor<Signer> {
	...
	pub(crate) fn new(
		...
		is_manual_broadcast: bool, user_channel_id: u128,
	...
	for Option<(BestBlock, ChannelMonitor<SP::EcdsaSigner>)>
{
	...
	fn read<R: io::Read>(reader: &mut R, args: (&'a ES, &'b SP)) -> Result<Self, DecodeError> {
		...
		read_tlv_fields!(reader, {
			...
			(43, user_channel_id, option), // Added in 0.4
		});
