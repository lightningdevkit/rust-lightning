...
use crate::chain::channelmonitor::{
	...
	WithChannelMonitor, LATENCY_GRACE_PERIOD_BLOCKS,
};
...
impl MonitorUpdateId {
	...
	pub(crate) fn from_new_monitor<ChannelSigner: WriteableEcdsaChannelSigner>(
...
pub trait Persist<ChannelSigner: WriteableEcdsaChannelSigner> {
	...
	fn persist_new_channel(
		&self, channel_funding_outpoint: OutPoint, data: &ChannelMonitor<ChannelSigner>,
	...
	fn update_persisted_channel(
		&self, channel_funding_outpoint: OutPoint, update: Option<&ChannelMonitorUpdate>,
	...
	P::Target: Persist<ChannelSigner>,
{
		...
		FN: Fn(&ChannelMonitor<ChannelSigner>, &TransactionData) -> Vec<TransactionOutputs>,
	{
		...
		let funding_outpoints: HashSet<OutPoint> =
			HashSet::from_iter(self.monitors.read().unwrap().keys().cloned());
	...
	P::Target: Persist<ChannelSigner>,
{
	...
	fn update_channel(
		...
		match monitors.get(&funding_txo) {
			None => {
				let logger =
					WithContext::from(&self.logger, update.counterparty_node_id, Some(channel_id));
			...
			Some(monitor_state) => {
				...
				match persist_res {
					ChannelMonitorUpdateStatus::InProgress => {
						...
						log_debug!(
							logger,
							"Persistence of ChannelMonitorUpdate for channel {} in progress",
							log_funding_info!(monitor)
						);
					},
					ChannelMonitorUpdateStatus::Completed => {
						log_debug!(
							logger,
							"Persistence of ChannelMonitorUpdate for channel {} completed",
							log_funding_info!(monitor)
						);
					},
					ChannelMonitorUpdateStatus::UnrecoverableError => {
