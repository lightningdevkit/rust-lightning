	...
	MR::Target: MessageRouter,
{
	...
	/// Verifies the provided [`AsyncPaymentsContext`] for an outbound [`HeldHtlcAvailable`] message.
	///
	...
	pub fn create_static_invoice_builder<'a, ES: Deref, R: Deref>(
		...
		amount_msats: Option<u64>, payment_secret: PaymentSecret, relative_expiry_secs: u32,
	...
	/// # Peers
	///
	/// The user must provide a list of [`MessageForwardNode`] that supports [`supports_onion_messages`] that will
	/// be used to generate valid reply paths for the counterparty to send back the corresponding [`Bolt12Invoice`]
	/// or [`InvoiceError`].
	///
	...
	/// # Peers
	///
	/// The user must provide a list of [`MessageForwardNode`] that supports [`supports_onion_messages`]
	/// that will be used to generate valid reply paths for the counterparty to send back the corresponding
	/// [`InvoiceError`] in case the user fails to pay the [`Bolt12Invoice`].
	///
	/// [`supports_onion_messages`]: crate::types::features::Features::supports_onion_messages
	...
	/// The user must provide a list of [`MessageForwardNode`] that supports [`supports_onion_messages`]
	/// that will be used to generate valid reply paths for the counterparty to send back the corresponding
	/// [`InvoiceError`] in case the user fails to pay the [`StaticInvoice`].
	///
	/// [`supports_onion_messages`]: crate::types::features::Features::supports_onion_messages
	#[cfg(async_payments)]
	...
	/// The user must provide a list of [`MessageForwardNode`] that supports [`supports_onion_messages`]
	/// that will be used to generate valid reply paths for the counterparty to send back the corresponding
	/// response for the [`DNSSECQuery`] message.
	///
	/// [`supports_onion_messages`]: crate::types::features::Features::supports_onion_messages
	#[cfg(feature = "dnssec")]
