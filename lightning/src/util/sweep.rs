	...
	O::Target: OutputSpender,
{
	...
	pub async fn regenerate_and_broadcast_spend_if_necessary(&self) -> Result<(), ()> {
		...
		let result = self.internal_regenerate_and_broadcast_spend_if_necessary().await;
	...
	pub async fn internal_regenerate_and_broadcast_spend_if_necessary(&self) -> Result<(), ()> {
