...
use crate::sign::{KeyMaterial, NodeSigner, Recipient, SignerProvider, SpendableOutputDescriptor};
...
pub trait DynSignerTrait: EcdsaChannelSigner + ChannelSignerExt + Send + Sync {}

#[cfg(taproot)]
/// A super-trait for all the traits that a dyn signer backing implements
pub trait DynSignerTrait:
	EcdsaChannelSigner + ChannelSignerExt + TaprootChannelSigner + Send + Sync
{
}
