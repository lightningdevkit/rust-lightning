...
use crate::chain::signer::{InMemorySigner, Recipient, EntropySource, NodeSigner, SignerProvider};
...
impl<Signer: signer::WriteableEcdsaChannelSigner> chainmonitor::Persist<Signer> for TestPersister {
...
impl NodeSigner for TestNodeSigner {
	fn get_inbound_payment_key_material(&self) -> crate::chain::signer::KeyMaterial {
		unreachable!()
	}
...
pub struct TestKeysInterface {
	pub backing: signer::PhantomKeysManager,
...
impl NodeSigner for TestKeysInterface {
	...
	fn get_inbound_payment_key_material(&self) -> signer::KeyMaterial {
...
impl TestKeysInterface {
	pub fn new(seed: &[u8; 32], network: Network) -> Self {
		...
		Self {
			backing: signer::PhantomKeysManager::new(seed, now.as_secs(), now.subsec_nanos(), seed),
