...
pub enum AsyncPaymentsContext {
	/// Context contained within the reply [`BlindedPath`] we put in outbound [`HeldHtlcAvailable`]
	/// messages, provided back to us in corresponding [`ReleaseHeldHtlc`] messages.
	///
