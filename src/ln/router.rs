...
impl_writeable_len_match!(DirectionalChannelInfo, {
	{ DirectionalChannelInfo { last_update_message: Some(msgs::ChannelUpdate { contents: msgs::UnsignedChannelUpdate { ref excess_data, ..}, .. }), .. }, 56 + 2 + 64 + excess_data.len() + 64 },
	{ _, 56 }
	}, {
	src_node_id,
	last_update,
