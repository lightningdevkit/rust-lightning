...
impl<'a, P: Poll, C: Cache, L: Deref> SpvClient<'a, P, C, L> where L::Target: Listen {
...
pub struct ChainNotifier<'a, C: Cache, L: Deref> where L::Target: Listen {
...
impl<'a, C: Cache, L: Deref> ChainNotifier<'a, C, L> where L::Target: Listen {
