//! Message, request, and other primitive types used to implement LSPS2 / bLIP-52.
...
/// An enum that captures all the valid JSON-RPC requests in the LSPS2 / bLIP-52 protocol.
...
#[derive(Clone, Debug, PartialEq, Eq)]
/// An enum that captures all the valid JSON-RPC responses in the LSPS2 / bLIP-52 protocol.
...
#[derive(Clone, Debug, PartialEq, Eq)]
/// An enum that captures all valid JSON-RPC messages in the LSPS2 / bLIP-52 protocol.
