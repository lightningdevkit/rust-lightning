...
//! Contains LSPS2 / bLIP-52 event types
...
pub enum LSPS2ClientEvent {
	...
	OpeningParametersReady {
		/// The identifier of the issued LSPS2 / bLIP-52 `get_info` request, as returned by
	...
	InvoiceParametersReady {
		/// The identifier of the issued LSPS2 / bLIP-52 `buy` request, as returned by
...
/// An event which an LSPS2 / bLIP-52 server should take some action in response to.
#[derive(Clone, Debug, PartialEq, Eq)]
